...
import { registerSerialTitleSearch, registerSerialTitleRetrieval, } from "./tools/serial-title.js";
...
async function main() {
    ...
    if (!apiKey) {
        console.error("ELSEVIER_API_KEY environment variable is required. Get one at https://dev.elsevier.com");
        process.exit(1);
    }
